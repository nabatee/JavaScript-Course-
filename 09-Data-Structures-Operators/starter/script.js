...
// for (let [score, player] of Object.entries(game.scored)) {
...
//   console.log(
//     `Odd of`,
//     team === 'x' ? `draw: ${odd}` : `victory ${game[team]}: ${odd}`
//   );
// }
...
// const scores = game.scored.reduce((s, player) => {
//   s[player] ? s[player]++ : (s[player] = 1);
//   return s;
// }, {});
// console.log(scores);
